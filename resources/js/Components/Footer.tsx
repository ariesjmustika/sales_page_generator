...
export default function Footer() {
    return (
        <footer className="mt-auto w-full border-t border-slate-200 dark:border-white/5 px-4 py-8">
            <div className="mx-auto flex max-w-7xl flex-col items-center justify-center space-y-2">
                <div className="flex items-center space-x-2 text-sm font-medium text-gray-500">
                    ...
                    <a
                        ...
                        className="font-semibold text-slate-900 dark:text-white transition-colors hover:text-indigo-500"
                    >
